...
public sealed partial class CriminalRecordsConsoleWindow : FancyWindow
{
    ...
    private void UpdateRecordActionButtons()
    {
        ...
        AddRecordButton.Disabled = !_access || string.IsNullOrWhiteSpace(SanitizeRecordName(FilterText.Text)); // Pirate: sanitize criminal record names before enabling create
        DeleteRecordButton.Disabled = !_access || _selectedKey == null;
        // Pirate: localize criminal console delete confirmation tooltip
    ...
    {
        // Pirate: sanitize any current filter input into a criminal record name and clamp it to the configured maximum
